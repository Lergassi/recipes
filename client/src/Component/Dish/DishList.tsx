...
import {DishApiInterface} from '../../Interface/DishApiInterface.js';
...
export default function DishList(props: DishListProps) {
    const [dishes, setDishes] = useState<DishApiInterface[]>([]);
        ...
        <div className={'dish-list-component'}>
            ...
            <div className={'item-list simple-block'}>
                {dishes.map((value, index, array) => {
                    /*
                    value.quality_id - как получить quality? Нужен alias.
                    Варианты:
                    - Вместе с запросом. Также как в сущности.
                    - Отдельным запросом с ID в ключах. Но тогда не будет сортировки от сервера.
